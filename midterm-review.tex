...
\begin{itemize}[nosep]
    ...
    \item Decryption round
          ...
          \end{itemize}
\end{itemize}
\begin{tikzpicture}[node distance=2cm,every node/.style={rectangle,minimum width=2cm}]
    \node (l0) {$LE_0$};
    \node[right=0cm of l0] (r0) {$RE_0$};
    \draw (l0.north west) rectangle (r0.south east);
    \draw[dashed] (l0.south east) -- (l0.north east);

    \node[fill=gray!50,below=of l0] (l1) {$LE_1$};
    \node[fill=gray!50,right=0cm of l1] (r1) {$RE_1$};
    \draw (l1.north west) rectangle (r1.south east);
    \draw[dashed] (l1.south east) -- (l1.north east);

    \node[fill=gray!50,below=of l1] (l2) {$LE_2$};
    \node[fill=gray!50,right=0cm of l2] (r2) {$RE_2$};
    \draw (l2.north west) rectangle (r2.south east);
    \draw[dashed] (l2.south east) -- (l2.north east);

    \path (r0.south) -- (r1.north) node[minimum size=0.5cm,draw,pos=0.25] (f1) {$F$} node[draw,circle,minimum size=0.25cm,pos=0.75] (oplus1) {};
    \node[right=1cm of f1,minimum size=0] (k1) {$K_1$};
    \draw ([yshift=-0.1cm]oplus1.north) -- ([yshift=0.1cm]oplus1.south);
    \draw ([xshift=-0.1cm]oplus1.east) -- ([xshift=0.1cm]oplus1.west);

    \path (r1.south) -- (r2.north) node[minimum size=0.5cm,draw,pos=0.25] (f2) {$F$} node[draw,circle,minimum size=0.25cm,pos=0.75] (oplus2) {};
    \node[right=1cm of f2,minimum size=0] (k2) {$K_2$};
    \draw ([yshift=-0.1cm]oplus2.north) -- ([yshift=0.1cm]oplus2.south);
    \draw ([xshift=-0.1cm]oplus2.east) -- ([xshift=0.1cm]oplus2.west);

    \draw[->] (l0.south) -- (oplus1.north west);
    \draw[->] (l1.south) -- (oplus2.north west);
    \draw[->] (r0) -- (f1);
    \draw[->] (r0.south) -- (l1.north);
    \draw[->] (f1) -- (oplus1);
    \draw[->] (oplus1) -- (r1);
    \draw[->] (r1) -- (f2);
    \draw[->] (r1.south) -- (l2.north);
    \draw[->] (f2) -- (oplus2);
    \draw[->] (oplus2) -- (r2);
    \draw[->] (k1) -- (f1.east);
    \draw[->] (k2) -- (f2.east);
...
\begin{tikzpicture}[node distance=2cm,every node/.style={rectangle, draw, minimum width=2cm}]
    \node (p1) {$P_1$};
    \node[fill=gray!50,below=of p1,minimum height=1cm] (e1) {Encrypt};
    \node[below=of e1] (c1) {$C_1$};

    \node[right=of p1] (p2) {$P_2$};
    \node[fill=gray!50,below=of p2,minimum height=1cm] (e2) {Encrypt};
    \node[below=of e2] (c2) {$C_2$};

    \node[draw=none,right=0.5cm of e2, minimum size=0] {$\dots$};

    \node[right=2cm of p2] (p3) {$P_n$};
    \node[fill=gray!50,below=of p3,minimum height=1cm] (e3) {Encrypt};
    \node[below=of e3] (c3) {$C_n$};
    ...
    \node[above left=0.1cm and 0.4cm of e1,draw=none,minimum size=0] (k1) {$K$};
    \node[above left=0.1cm and 0.4cm of e2,draw=none,minimum size=0] (k2) {$K$};
    \node[above left=0.1cm and 0.4cm of e3,draw=none,minimum size=0] (k3) {$K$};
    \draw[->] (k1) |- (e1.west);
    \draw[->] (k2) |- (e2.west);
    \draw[->] (k3) |- (e3.west);
\end{tikzpicture}
...
% \begin{tikzpicture}[node distance=2cm,every node/.style={rectangle, draw, minimum width=2cm}]
%     \node (c1) {$C_1$};
%     \node[fill=gray!50,below=of c1,minimum height=1cm] (d1) {Decrypt};
%     \node[below=of d1] (p1) {$P_1$};

%     \node[right=of c1] (c2) {$C_2$};
%     \node[fill=gray!50,below=of c2,minimum height=1cm] (d2) {Decrypt};
%     \node[below=of d2] (p2) {$P_2$};

%     \node[draw=none,right=0.5cm of d2, minimum size=0] {$\dots$};

%     \node[right=2cm of c2] (c3) {$C_n$};
%     \node[fill=gray!50,below=of c3,minimum height=1cm] (d3) {Decrypt};
%     \node[below=of e3] (p3) {$P_n$};
...
%     \node[above left=0.1cm and 0.4cm of d1,draw=none,minimum size=0] (k1) {$K$};
%     \node[above left=0.1cm and 0.4cm of d2,draw=none,minimum size=0] (k2) {$K$};
%     \node[above left=0.1cm and 0.4cm of d3,draw=none,minimum size=0] (k3) {$K$};
%     \draw[->] (k1) |- (d1.west);
%     \draw[->] (k2) |- (d2.west);
%     \draw[->] (k3) |- (d3.west);
% \end{tikzpicture}
...
\begin{tikzpicture}[node distance=2cm,every node/.style={rectangle, draw, minimum width=2cm}]
    ...
    \node[draw=none,right=0.5cm of e2, minimum size=0] (dots) {$\dots$};

    \node[right=2cm of p2] (p3) {$P_n$};
    \node[fill=gray!50,below=of p3,minimum height=1cm] (e3) {Encrypt};
    \node[below=of e3] (c3) {$C_n$};

    \draw[->] (p1) -- (e1) node[pos=0.5,circle,minimum size=0.5cm,fill=gray!50] (f1) {};
    \draw[->] (p1) -- (f1);
    \draw[->] (e1) -- (c1);
    \draw[->] (p2) -- (e2) node[pos=0.5,circle,minimum size=0.5cm,fill=gray!50] (f2) {};
    \draw[->] (p2) -- (f2);
    \draw[->] (e2) -- (c2);
    \draw[->] (p3) -- (e3) node[pos=0.5,circle,minimum size=0.5cm,fill=gray!50] (f3) {};
    \draw[->] (p3) -- (f3);
    \draw[->] (e3) -- (c3);

    \draw (f1.north) -- (f1.south);
    \draw (f2.north) -- (f2.south);
    \draw (f3.north) -- (f3.south);
    \draw (f1.east) -- (f1.west);
    \draw (f2.east) -- (f2.west);
    \draw (f3.east) -- (f3.west);


    \node[above left=0.1cm and 0.4cm of e1,draw=none,minimum size=0] (k1) {$K$};
    \node[above left=0.1cm and 0.4cm of e2,draw=none,minimum size=0] (k2) {$K$};
    \node[above left=0.1cm and 0.4cm of e3,draw=none,minimum size=0] (k3) {$K$};
    \node[above=1.25cm of k1,draw=none,minimum size=0] (iv) {$IV$};
    \draw[->] (k1) |- (e1.west);
    \draw[->] (k2) |- (e2.west);
    \draw[->] (k3) |- (e3.west);

    \draw[->] (iv) |- (f1);
    \path[draw,->] (c1.east) -- ([xshift=1cm]c1.east) -- ([xshift=-1.75cm]f2.west) -- (f2.west);
    \draw (c2.east) -| (dots.south west);
    \draw[->] (dots.north) |- (f3.west);
\end{tikzpicture}
...
\begin{tikzpicture}[node distance=2cm,every node/.style={rectangle, draw, minimum width=2cm}]
    ...
    \node[fill=gray!50,minimum height=1cm,below=1cm of nonce] (e1) {Encrypt};
    \node[above left=0.25cm and 0.5cm of e1,draw=none,minimum size=0] (k1) {$K$};
    \draw[->] (k1) |- (e1);
    \draw[->] (nonce) -- (e1);
    \node[below=of e1] (c1) {$C_1$};
    \path (e1) -- (c1) node[circle,fill=gray!50,minimum size=0.5cm,pos=0.6] (f1) {};
    \draw (f1.north) -- (f1.south);
    \draw (f1.east) -- (f1.west);
    \node[above left=0.25cm and 1cm of f1] (p1) {$P_1$};
    \draw[->] (p1.south) |- (f1.west);
    \draw[->] (e1) -- (f1);
    \draw[->] (f1) -- (c1);

    \node[fill=gray!50,minimum height=1cm,right=of e1] (e2) {Encrypt};
    \node[above left=0.25cm and 0.5cm of e2,draw=none,minimum size=0] (k2) {$K$};
    \draw[->] (k2) |- (e2);
    \node[below=of e2] (c2) {$C_2$};
    \path (e2) -- (c2) node[circle,fill=gray!50,minimum size=0.5cm,pos=0.6] (f2) {};
    \draw (f2.north) -- (f2.south);
    \draw (f2.east) -- (f2.west);
    \node[above left=0.25cm and 1cm of f2] (p2) {$P_2$};
    \draw[->] (p2.south) |- (f2.west);
    \draw[->] (e2) -- (f2);
    \draw[->] (f2) -- (c2);

    \node[draw=none,right=0.5cm of e2, minimum size=0] (dots) {$\dots$};

    \node[fill=gray!50,minimum height=1cm,right=of dots] (e3) {Encrypt};
    \node[above left=0.25cm and 0.5cm of e3,draw=none,minimum size=0] (k3) {$K$};
    \draw[->] (k3) |- (e3);
    \node[below=of e3] (c3) {$C_n$};
    \path (e3) -- (c3) node[circle,fill=gray!50,minimum size=0.5cm,pos=0.6] (f3) {};
    \draw (f3.north) -- (f3.south);
    \draw (f3.east) -- (f3.west);
    \node[above left=0.25cm and 1cm of f3] (p3) {$P_n$};
    \draw[->] (p3.south) |- (f3.west);
    \draw[->] (e3) -- (f3);
    \draw[->] (f3) -- (c3);

    \draw[->] ([yshift=-0.1cm]e1.south) -- ([xshift=1.5cm, yshift=-0.1cm]e1.south) -- ([xshift=1.5cm, yshift=2cm]e1.south) -| (e2.north);
    \draw ([yshift=-0.1cm]e2.south) -- ([xshift=1.5cm, yshift=-0.1cm]e2.south) -- (dots.south west);
    \draw[->] (dots.north) |- ([yshift=1cm]e3.north) -- (e3.north);

    \draw[dashed] ([xshift=-1cm,yshift=0.1cm]nonce.north west) rectangle ([xshift=1cm,yshift=-0.1cm]e3.south east);
\end{tikzpicture}

\subsubsection*{CFB}

\begin{tikzpicture}[node distance=2cm,every node/.style={rectangle, draw, minimum width=2cm}]
    \node[draw=none,minimum size=0] (iv) {$IV$};

    \node[fill=gray!50,minimum height=1cm,below=1cm of iv] (e1) {Encrypt};
    \node[above left=0.25cm and 0.5cm of e1,draw=none,minimum size=0] (k1) {$K$};
    \draw[->] (k1) |- (e1);
    \draw[->] (iv) -- (e1);
    \node[below=of e1] (c1) {$C_1$};
    ...
    \draw[->] (c1.east) -- ([xshift=0.5cm]c1.east) -- ([xshift=0.5cm, yshift=4cm]c1.east) -| (e2.north);
    \draw (c2.east) -- ([xshift=0.5cm]c2.east) -- (dots.south west);
    \draw[->] (dots.north) |- node[draw=none,pos=0.65,above]{$C_{n-1}$} ([yshift=1cm]e3.north) -- (e3.north);
...
\begin{tikzpicture}[node distance=2cm,every node/.style={rectangle, draw, minimum width=2cm}]
    \node (ctr1) {Counter 1};
    \node[fill=gray!50,minimum height=1cm,below=1cm of ctr1] (e1) {Encrypt};
    \node[above left=0.25cm and 0.5cm of e1,draw=none,minimum size=0] (k1) {$K$};
    \draw[->] (k1) |- (e1);
    \draw[->] (ctr1) -- (e1);
    \node[below=of e1] (c1) {$C_1$};
    ...
    \node[right=of ctr1] (ctr2) {Counter 2};
    \node[fill=gray!50,minimum height=1cm,below=1cm of ctr2] (e2) {Encrypt};
    \node[above left=0.25cm and 0.5cm of e2,draw=none,minimum size=0] (k2) {$K$};
    \draw[->] (k2) |- (e2);
    \draw[->] (ctr2) -- (e2);
    \node[below=of e2] (c2) {$C_2$};
    ...
    \node[right=3.25cm of ctr2] (ctr3) {Counter $n$};
    \node[fill=gray!50,minimum height=1cm,below=1cm of ctr3] (e3) {Encrypt};
    \node[above left=0.25cm and 0.5cm of e3,draw=none,minimum size=0] (k3) {$K$};
    \draw[->] (k3) |- (e3);
    \draw[->] (ctr3) -- (e3);
    \node[below=of e3] (c3) {$C_n$};
...
\end{itemize}
proves \glsname{authenticity} and \glsname{integrity}
...
\begin{tikzpicture}[every node/.style={draw, rectangle, fill=gray!40}, node distance=2.5cm, minimum width=2cm, minimum height=0.75cm]
    \node (m1) {$M_1$};
    \node[below=of m1] (e1) {Encrypt};
    \node[draw=none,fill=none,node distance=0.5cm, left=of e1, minimum size=0] (k1) {$K$};

    \node[right=of m1] (m2) {$M_2$};
    \node[below=of m2] (e2) {Encrypt};
    \node[draw=none,fill=none,node distance=0.5cm, left=of e2, minimum size=0] (k2) {$K$};

    \node[right=of m2] (m3) {$M_n$};
    \node[below=of m3] (e3) {Encrypt};
    \node[node distance=0.5cm,below=of e3,draw=none,fill=none,minimum size=0] (tag) {tag};
    \node[draw=none,fill=none,node distance=0.5cm, left=of e3, minimum size=0] (k3) {$K$};
    \path (m2) -- (m3) node[draw=none,fill=none, pos=0.5] {$\dots$};
    ...
    \path (m2) -- (e2) node[circle,pos=0.5,minimum size=0.5cm] (c2) {};
    \draw (c2.north) -- (c2.south);
    \draw (c2.east) -- (c2.west);
    \path (m3) -- (e3) node[circle,pos=0.5,minimum size=0.5cm] (c3) {};
    \draw (c3.north) -- (c3.south);
    \draw (c3.east) -- (c3.west);
    ...
    \path[draw,->] (e1.south) -- ([yshift=-0.5cm]e1.south) -- ([xshift=1.75cm,yshift=-0.5cm]e1.south) -- ([xshift=-2.75cm]c2.center) -- (c2.west);
    \path[dashed,draw,->] (e2.south) -- ([yshift=-0.5cm]e2.south) -- ([xshift=1.75cm,yshift=-0.5cm]e2.south) -- ([xshift=-2.75cm]c3.center) -- (c3.west);

\end{tikzpicture}
\subsubsection*{Cipher-based MAC (CMAC)}
\begin{itemize}[nosep]
    \item thwarts forgery for variable-length messages
    \item second key $k_1$ derived from $E(k, 0)$
\end{itemize}
...
\begin{tikzpicture}[every node/.style={draw, rectangle, fill=gray!40}, node distance=2.5cm, minimum width=2cm, minimum height=0.75cm]
    ...
    \node[right=of m2] (m3) {$M_n$};
    \node[below=of m3] (e3) {Encrypt};
    \node[node distance=0.5cm,below=of e3] (msb) {$MSB(\texttt{Tlen})$};
    \node[minimum size=0,draw=none,fill=none,node distance=0.5cm,right=of msb] (t) {$T$};
    \node[draw=none,fill=none,node distance=0.5cm, left=of e3, minimum size=0] (k3) {$K$};
    \path (m2) -- (m3) node[draw=none,fill=none, pos=0.5] {$\dots$};
    \draw[->] (msb.east) -- (t);
    ...
    \node[node distance=0.5cm,right=of c3),draw=none,fill=none,minimum size=0] (new k) {$K_1$};
    \draw[->] (new k) -- (c3.east);
...
\begin{itemize}[nosep]
    \item provably secure if hash is pseudorandom
    \item works with any hash
          \begin{itemize}[nosep]\item more efficient with iterative hash\end{itemize}
    \item widely used
\end{itemize}
...
\end{itemize}
\begin{tikzpicture}[every node/.style={draw, rectangle, minimum height=0.6cm}]
    \node[fill=gray!50,minimum size=0.5cm] (oplus1) {$\oplus$};
    \node[draw=none,minimum size=0,above left of=oplus1] (k1) {$K^+$};
    \node[draw=none,minimum size=0,above right of=oplus1] (ipad) {\texttt{ipad}};
    \draw[->] (k1) |- (oplus1);
    \draw[->] (ipad) |- (oplus1);

    \node[below=0.5cm of oplus1,minimum width=1.5cm] (si) {$S_i$};
    \node[right=0cm of si, minimum width=3cm] (m1) {$M$};
    \draw[->] (oplus1) -- (si);

    \node[fill=gray!50,minimum size=0.5cm, below=2cm of oplus1] (oplus2) {$\oplus$};
    \node[draw=none,minimum size=0,above left of=oplus2] (k2) {$K^+$};
    \node[draw=none,minimum size=0,above right of=oplus2] (opad) {\texttt{opad}};
    \draw[->] (k2) |- (oplus2);
    \draw[->] (opad) |- (oplus2);

    \node[below right=0.5cm and 0.5cm of oplus2.south west,minimum width=1.5cm] (so) {$S_o$};
    \node[right=0cm of so, minimum width=1.5cm] (m2) {};
    \draw[->] (oplus2.south) -- ([yshift=-0.25cm]oplus2.south) -| (so.north);

    \node[minimum size=1cm,below=0.25cm of m1,fill=gray!30] (h1) {Hash};
    \node[minimum size=1cm,right=0.25cm of m2,fill=gray!30] (h2) {Hash};

    \draw[->] (m1) -- (h1);
    \draw[->] (h1) -- ([xshift=-0.25cm]m2.north);
    \draw[->] (m2) -- (h2);
\end{tikzpicture}
...
\begin{itemize}[nosep]
    ...
    \item Standard: PKCS \#1
          \begin{itemize}[nosep]
              \item RSASSA-PKCS1-v1\textunderscore5
              \item RSASSA-PSS
                    \begin{itemize}[nosep]
...
\end{itemize}
\subsection{Kerberos}
\glsname{extended needham-schroeder protocol} --- \glsdesc{extended needham-schroeder protocol}

uses nonces

\glsname{kerberos network authentication protocol}
\begin{itemize}[nosep]
    \item nodes can communicate over a non-secure network and to prove their identities to each other
    \item similar to \glsname{extended needham-schroeder protocol} but uses timestamp instead of nonce
\end{itemize}
...
\begin{itemize}[nosep]
    ...
    \item requirements
          ...
          \end{enumerate}
\end{itemize}
\glsname{X.509 certificate} --- \glsdesc{X.509 certificate}
