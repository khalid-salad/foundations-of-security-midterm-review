...
\newacronym{cia}{CIA}{\gls{confidentiality}, \gls{integrity}, and \gls{availability}}
\newacronym{dos}{DoS}{\gls{denial of service}}
\newacronym{cca}{CCA}{\gls{chosen ciphertext attack}}
\newacronym{cpa}{CPA}{\gls{chosen plaintext attack}}
\newacronym{coa}{COA}{\gls{ciphertext only attack}}
\newacronym{kpa}{KPA}{\gls{known plaintext attack}}
\newacronym{prng}{PRNG}{\gls{pseudorandom number generator}}
\newacronym{des}{DES}{\gls{data encryption standard}}
\newacronym{aes}{AES}{\gls{advanced encryption standard}}
\newacronym{3des}{3DES}{\gls{triple des}}
\newacronym{2des}{2DES}{\gls{double des}}
\newacronym{ecb}{ECB}{\gls{electronic code book}}
\newacronym{cbc}{CBC}{\gls{cipher block chaining}}
\newacronym{ofb}{OFB}{\gls{output feedback}}
\newacronym{cfb}{CFB}{\gls{cipher feedback}}
\newacronym{ctr}{CTR}{\gls{counter mode}}
\newacronym{rsa}{RSA}{Rivest, Shamir, Adleman \gls{rsa cryptosystem}}
\newacronym{md5}{MD5}{\gls{md5 message-digest algorithm}}
\newacronym{sha}{SHA}{Secure Hash Algorithm \gls{sha1}, \gls{sha2}, \gls{sha3}}
\newacronym{mac}{MAC}{\gls{message authentication code}}
\newacronym{cmac}{CMAC}{\gls{cipher-based mac}}
\newacronym{hmac}{HMAC}{\gls{hash-based mac}}
\newacronym{ccm}{CCM}{\gls{counter with cbc-mac}}
\newacronym{pss}{PSS}{probabilistic signature scheme}
\newacronym{dsa}{DSA}{\gls{digital signature algorithm}}
\newacronym{fips}{FIPS}{Federal Information Processing Standard}
\newacronym{ecdsa}{ECDSA}{\gls{elliptic curve digital signature algorithm}}